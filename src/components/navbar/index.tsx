      ...
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          <Link to="/affiliate/menu">
            <NavigationMenuLink className={navigationMenuTriggerStyle()}>
              <span className={`${path.includes("/menu") && "text-green-400"}`}>
                Menu
              </span>
            </NavigationMenuLink>
          </Link>
      ...
      <div className=" h-14 sticky top-0 z-50 max-w-7xl  bg-darkGrey border-b border-lightBlack  ">
        <div className="mx-auto flex items-center justify-between p-2">
          ...
          <div className=" flex items-center gap-x-4">
            ...
            {/* SETTINGS ICON */}
            <div className="hidden md:grid  h-8 w-8 group cursor-pointer bg-gray-500 hover:bg-green-400 transition-colors duration-300 ease-in-out  place-content-center rounded-lg">
          ...
          <div className="hidden md:flex text-light  gap-x-2">
            <MapPin />
            <p className="">10 test address test city</p>
          </div>
