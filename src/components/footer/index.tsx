export function Footer() {
  return (
    <footer className="mt-auto bg-lightBlack w-full">
          ...
          <div className="col-span-1">
            ...
            <div className="mt-3 grid space-y-3">
              ...
              <p>
                ...
                <span className="inline ms-1 text-xs bg-green-400 text-white py-1 px-2 rounded-lg">
                  We're hiring
                </span>
              </p>
              <p>
          ...
          <div className="col-span-2">
            ...
            <form>
              <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 ">
                ...
                <a
                  className="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-green-400 text-white hover:bg-green-700 disabled:opacity-50 disabled:pointer-events-none"
                  href="#"
                >
                  Subscribe
                </a>
        ...
        <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-400 ">
              © 2024 Diet dining. All rights reserved.
            </p>
          </div>
