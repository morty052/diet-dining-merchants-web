...
function ButtonLoader(params: type) {
  return (
    <div className="">
...
export function Combobox({
  ...
  async function createCategory() {
    ...
    setStoreCategories((prev) => [{ value: newCategoryValue, label: newCategoryValue }, ...prev])
    setNewCategoryValue('')
  }
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button role="combobox" aria-expanded={open} className=" w-full flex-1 justify-between py-2">
          ...
          {creatable && (
            <div className="flex">
              ...
              >
                ...
                {!loading && !created && <Plus className="h-4 w-4 text-white" />}
