  ...
  return (
    <div className="max-w-3xl  border-red-300 gap-2 grid grid-cols-2">
      <div className="w-full bg-indigo-300">
        <div className="">
          <h1 className="text-light font-black leading-[2.5rem] ">
      ...
      <div className="space-y-4 flex flex-col ">
        <div className="flex-1 border bg-pink-300"></div>
        <div className="flex-1  border bg-yellow-300"></div>
      </div>
    </div>
  );
}
...
function HomeHero() {
  return (
    <section className="max-w-6xl mx-auto px-2 lg:px-4  lg:grid grid-cols-2 lg:gap-x-5 xl:gap-x-10 ">
      {/* <Bento /> */}
